      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <div role="group" aria-labelledby="contact-title">
            ...
            <SectionTitle
              id="contact-title"
              ariaDescribedby="contact-subtitle"
              className="mb-4"
            >
              {title}
            </SectionTitle>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white/80 backdrop-blur-sm border-2 border-princess-medium/30 rounded-2xl p-8 shadow-xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-semibold text-princess-dark mb-2"
                >
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-princess-dark mb-6">
                Let&apos;s Connect
              </h3>
              <p className="text-princess-dark/70 leading-relaxed mb-6">
                Ready to make your event magical? We&apos;d love to hear from
                you! Get in touch to book your favorite character.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-princess-gold/20 border-2 border-princess-gold/50 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg
                    className="w-6 h-6 text-princess-gold"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div>
                  <div className="font-semibold text-princess-dark mb-1">
                    Email
                  </div>
                  <a
                    href="mailto:contact@drprincessparties.com"
                    className="text-princess-dark/70 hover:text-princess-gold transition-colors duration-200"
                  >
            ...
            {/* Social Links */}
            <div>
              <div className="font-semibold text-princess-dark mb-4">
                Follow Us
              </div>
